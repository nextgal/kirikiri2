...
print FH "¥t/* n = 0 (not used) */¥n";
print FH "¥t{¥n";

for($y = 0; $y < 64; $y++)
{
	print FH ",¥n" if $y != 0;
	printf FH "¥t¥t/* y = %2d */ {0, 0, 0, 0, 0, 0, 0, 0}", $y;
}
print FH "¥n";
print FH "¥t},¥n";
...
for($n = 1; $n <= 62; $n++)
{
	...
	print FH "¥t/* n = $n */¥n";
	printf FH "¥t/* α = (%d, %d)  β = (%d, %d) */¥n", $a_x, $a_y, $b_x, $b_y;
	...
	{
		print FH ",¥n" if $y != 0;
		printf FH "¥t¥t/* y = %2d */ /* l = %3d, r = %2d */ {%2d, %2d, %7d, %7d, %7d, %7d, %8d, %8d}",
			$y, $starts[$y], $ends[$y],
			$starts[$y], $len[$y],
			$sx[$y], $sy[$y], $ex[$y], $ey[$y],
			$stepx[$y], $stepy[$y];
